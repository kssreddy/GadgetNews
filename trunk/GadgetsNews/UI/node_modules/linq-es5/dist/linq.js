...
var Union = (function (_super) {
    ...
    function Union(sourceIterator, _keySelector) {
        _super.call(this, sourceIterator, function (o) { return o; });
        this._keySelector = _keySelector;
        this._set = new Set();
    }
...
var EnumerableImpl = (function () {
    ...
    EnumerableImpl.prototype.Except = function (other, kesSelector) {
        var _this = this;
        return new EnumerableImpl(this, function () { return new Iterator.Intersect(_this[Symbol.iterator](), Constant.getKeys(other, kesSelector), true, kesSelector); });
    };
    ...
    EnumerableImpl.prototype.OrderBy = function (keySelect, equal) {
        if (keySelect === void 0) { keySelect = Constant.selfFn; }
        if (equal === void 0) { equal = function (a, b) { return a - b; }; }
...
},{"./iterators":1,"./utilities":3,"es6-shim":5}],3:[function(require,module,exports){
///////////////////////////////////////////////////////////////////////////////
/** Copyright (c) ENikS.  All rights reserved.                               */
//
// Licensed under the Apache License, Version 2.0  ( the  "License" );  you may 
